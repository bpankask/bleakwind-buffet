 ...
 * Last Modified: 
 * Purpose: Able to return all available menu items
 */
...
namespace BleakwindBuffet.Data
{
    ...
    public static class Menu
    {
        ...
        /// <summary>
        /// Method to filter menu to search item
        /// </summary>
        ...
        public static IEnumerable<IOrderItem> Search(string terms)
        {
            ...
            foreach (IOrderItem item in FullMenu)
            {
                ...
                if (item != null && terms != null && item.ToString().ToLower().Contains(terms.ToLower()))
                {
                    results.Add(item);
                }
            }
        ...
        /// <summary>
        /// Method to filter menu by catagory
        /// </summary>
        /// <param name="items"></param>
        /// <param name="catagory"></param>
        /// <returns></returns>
        public static IEnumerable<IOrderItem> FilterByCatagory(IEnumerable<IOrderItem> items, IEnumerable<string> catagory)
        {
            List<IOrderItem> results = new List<IOrderItem>();
            ...
            foreach (IOrderItem item in items)
            {
                if(item is Entree)
                {
                    if (catagory != null && catagory.Contains("Entree"))
                    {
                        results.Add(item);
                    }
                }
                ...
                if (item is Side)
                {
                    if (catagory != null && catagory.Contains("Side"))
                    {
                        results.Add(item);
                    }
                }
                ...
                if (item is Drink)
                {
                    if (catagory != null && catagory.Contains("Drink"))
                    {
                        results.Add(item);
                    }
                }
        ...
        /// <summary>
        /// Method to filter menu by Price
        /// </summary>
        /// <param name="items"></param>
        ...
        /// <summary>
        /// Method to filter menu by calories
        /// </summary>
        /// <param name="items"></param>
        /// <param name="min"></param>
        /// <param name="max"></param>
